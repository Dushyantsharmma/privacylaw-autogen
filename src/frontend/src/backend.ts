...
export class Backend implements backendInterface {
    ...
    async addTeamMember(arg0: Principal, arg1: Principal): Promise<void> {
        if (this.processError) {
            try {
    ...
    async canGenerate(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.canGenerate();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMyPlan(): Promise<Subscription> {
        if (this.processError) {
            try {
                const result = await this.actor.getMyPlan();
                return from_candid_Subscription_n6(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getUsageCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getUsageCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserPlan(arg0: Principal): Promise<Subscription> {
        if (this.processError) {
            try {
    ...
    async incrementUsage(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.incrementUsage();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async inspectWebsite(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.inspectWebsite(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeTeamMember(arg0: Principal, arg1: Principal): Promise<void> {
        if (this.processError) {
            try {
    ...
    async setUserPlan(arg0: Principal, arg1: string, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async upgradePlan(arg0: Principal, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.upgradePlan(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_Subscription_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Subscription): Subscription {
...
function from_candid_record_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        teamOwner: record_opt_to_undefined(from_candid_opt_n8(_uploadFile, _downloadFile, value.teamOwner)),
        monthlyUsageCount: value.monthlyUsageCount,
        usageResetTimestamp: value.usageResetTimestamp,
